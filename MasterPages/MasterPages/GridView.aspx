<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GridView.aspx.cs" Inherits="MasterPages.GridView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class ="text-center">GridView Page<table class="w-100">
        <tr>
            <td colspan="2">
                <asp:Label runat="server" Text="LblMsg" ID="LblMsg"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
